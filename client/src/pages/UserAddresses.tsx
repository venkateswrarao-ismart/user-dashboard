      ...
      <div className="bg-gray-50 min-h-screen p-4 sm:p-6">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold">My Addresses</h1>
          ...
          {/* ADDRESS LIST */}
          {isLoading ? (
            <div className="flex justify-center p-10 sm:p-20">
              <Loader2 className="h-8 w-8 animate-spin" />
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {addresses.map((a) => (
                <Card 
                  key={a.id} 
                  className={`${a.is_default ? "border-blue-600 border-2" : ""} transition-all duration-200 hover:shadow-md`}
                >
                  <CardHeader className="pb-3">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <CardDescription className="flex items-center gap-1 mt-1">
                          {a.address_type === "home" && <Home className="h-3 w-3" />}
                          {a.address_type === "work" && <MapPin className="h-3 w-3" />}
                          {a.address_type}
                        </CardDescription>
                      </div>
                      {a.is_default && (
                  ...
                  <CardContent className="pb-3">
                    <div className="space-y-1 text-sm">
                      <p className="font-medium">{a.address_line1}</p>
          ...
          <DialogContent className="sm:max-w-lg max-h-[90dvh] overflow-y-auto p-4 sm:p-6">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                {/* CITY, STATE, COUNTRY - Responsive layout */}
